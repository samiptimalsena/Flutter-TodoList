      ...
      child:Column(
        ...
        children: <Widget>[
          ...
          ButtonBar(
            children: <Widget>[
              FlatButton(
                child:Text("Completed",style:TextStyle(color: Colors.orangeAccent,fontFamily: "Roboto",fontSize:15)),
                onPressed: (){
                  onComplete();
                },
              ),
              FlatButton(
                ...
                child: Text("Remove",style:TextStyle(color: Colors.red,fontFamily: "Roboto",fontSize:15)),
                )
            ],
          )
      ],)
        ...
        children: <Widget>[
          ...
          Column(
            children: todoList.map((currentTask) {
              return Task(currentTask.title, currentTask.subTitle,onDelete:()=> removeItem(currentTask.title),onComplete:()=>taskCompleted(currentTask.title));
            }).toList(),
          ),
        ...
        body:Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Field(subTitleHandler, "Briefly describe your task", "Sub-title"),
              Container(
